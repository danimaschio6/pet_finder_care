...
export default function PetNewsScreen() {
  ...
  const URL = (p: number) => `https://newsapi.org/v2/everything?q=mascotas AND cuidado AND veterinaria&language=es&pageSize=10&page=${p}&sortBy=publishedAt&apiKey=${API_KEY}`;
